...
module TruthSerum
  ...
  LEX_TESTS = {
    ...
    '"\"'           => [:term, '"'],
    '"\""\"'        => [:term, '"', :term, '\\'],
    'word AND join' => [:term, 'word', :space, ' ', :operator, 'AND', :space, ' ', :term, 'join'],
    '-word AND join' => [:minus, '-', :term, 'word', :space, ' ', :operator, 'AND', :space, ' ', :term, 'join'],
    'word OR +join' => [:term, 'word', :space, ' ', :operator, 'OR', :space, ' ', :plus, '+', :term, 'join']
  }.freeze
